  ...
  return (
    <section id="experience" className="mx-auto max-w-4xl px-6">
      ...
      <div className="relative border-l border-white/10 pl-6 sm:pl-8">
        ...
        >
          <div className="absolute -left-[35px] flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-[#050507] shadow-accent-sm sm:-left-[43px]">
            <Briefcase className="h-5 w-5 text-accent" />
          </div>
          
          <div className="rounded-2xl border border-white/10 bg-[#0d0d11] p-6 hover:border-accent/30 transition-colors glow-card">
