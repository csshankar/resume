    ...
    return (
        <div >
            ...
            <div className="flex items-center gap-2">
                ...
                <a href="/assets/KumarResume.pdf" download=""   className="bg-gray-900 px-4 sm:h-11 h-10 mt-8 rounded-xl flex items-center justify-center md:text-base text-sm text-white border-2 border-sky-500 hover:bg-gray-700  transition duration-500" type="submit">  Resume   </a>
                </button>
                <button >
